  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-3">
        <select class="px-4 py-2 text-sm bg-white border border-blue-100 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        ...
        <p 
          class="text-sm mt-2"
          :class="stat.positive ? 'text-emerald-600' : 'text-red-600'"
        >
          {{ stat.change }}
        </p>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        <div 
          ...
          :class="report.color"
        >
          <svg v-if="report.icon === 'chart'" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
          <svg v-else-if="report.icon === 'leads'" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
          </svg>
          <svg v-else-if="report.icon === 'team'" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card title="Sales Pipeline" subtitle="Deals by stage">
        <div class="h-64 flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl">
          <div class="text-center">
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex items-center space-x-4">
              ...
              <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                {{ performer.avatar }}
              </div>
              <div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            <thead class="bg-blue-50/50">
              <tr>
                <th class="px-6 py-3 text-left text-xs font-semibold text-blue-600 uppercase">Company</th>
                <th class="px-6 py-3 text-left text-xs font-semibold text-blue-600 uppercase">Value</th>
                <th class="px-6 py-3 text-left text-xs font-semibold text-blue-600 uppercase">Date</th>
                <th class="px-6 py-3 text-left text-xs font-semibold text-blue-600 uppercase">Rep</th>
              </tr>
            </thead>
