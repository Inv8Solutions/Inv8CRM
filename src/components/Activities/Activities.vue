...
const activities: Activity[] = [
  ...
  },
  {
    ...
    type: 'email',
    title: 'Send Proposal',
    description: 'Q1 partnership proposal',
  ...
  },
  {
    ...
    description: 'Add notes from last meeting',
    contact: 'David Kim',
  ...
  },
  {
    ...
    type: 'note',
    title: 'Meeting Notes',
    description: 'Documented key discussion points',
    contact: 'Amanda Lee',
    company: 'CloudPro',
    date: 'Feb 1',
    time: '3:00 PM',
  ...
  },
  {
    ...
    type: 'email',
    title: 'Welcome Email',
    description: 'Onboarding information sent',
...
const getTypeIcon = (type: Activity['type']) => {
  switch (type) {
    ...
    case 'email':
      return { icon: 'email', color: 'bg-indigo-500' }
    case 'meeting':
      return { icon: 'meeting', color: 'bg-emerald-500' }
    case 'task':
      return { icon: 'task', color: 'bg-amber-500' }
    case 'note':
      return { icon: 'note', color: 'bg-gray-500' }
    default:
      return { icon: 'task', color: 'bg-gray-500' }
  }
}
    ...
    <Card>
      <div class="space-y-6">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center flex-wrap gap-4 text-xs text-gray-500">
                  ...
                  <span class="flex items-center">
                    <div
                      class="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center text-xs font-medium text-blue-600 mr-1"
                    >
        ...
        <div>
          ...
          <div class="space-y-4">
            <div
              v-for="activity in filteredActivities.filter(
                (a) => !['Today', 'Yesterday'].includes(a.date),
              )"
              :key="activity.id"
              class="flex items-start space-x-4 p-4 rounded-xl hover:bg-blue-50/50 transition-colors cursor-pointer border border-blue-50"
            >
