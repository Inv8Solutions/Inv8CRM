    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        <thead class="bg-blue-50/50">
          <tr>
            <th
              class="px-6 py-3 text-left text-xs font-semibold text-blue-600 uppercase tracking-wider"
            >
              Company
            </th>
            <th
          ...
          >
            <td class="px-6 py-4">
              <div class="flex items-center">
                <div
                  class="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center text-white text-xs font-medium mr-3"
                >
