...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 flex items-center justify-center p-4"
  >
    <!-- Background Pattern -->
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute -top-40 -right-40 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl"></div>
      <div
        class="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-400/20 rounded-full blur-3xl"
      ></div>
    </div>
    ...
    <div class="relative w-full max-w-md">
      ...
      <!-- Footer -->
      <p class="text-center mt-8 text-blue-200 text-sm">© 2026 Inv8CRM. All rights reserved.</p>
    </div>
  </div>
</template>
